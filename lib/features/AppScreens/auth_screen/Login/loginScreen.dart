...
import 'package:tourist_app/features/AppScreens/auth_screen/Login/cubit/loginViewModel.dart';
    ...
    return BlocListener<Loginviewmodel, AuthState>(
      ...
      listener: (context, state) {
        if (state is AuthLoadingState) {
          DialogeUtils.showLoading(context: context, text: "Loading...");
