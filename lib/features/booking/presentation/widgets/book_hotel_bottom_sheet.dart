...
class BookHotelBottomSheet extends StatefulWidget {
  final String hotelId;
  final String hotelName;

  const BookHotelBottomSheet({
    super.key,
    required this.hotelId,
    required this.hotelName,
  });

  static void show(BuildContext context, String hotelId, String hotelName) {
    showModalBottomSheet(
      ...
      builder: (context) {
        return BookHotelBottomSheet(hotelId: hotelId, hotelName: hotelName);
      },
    );
  }

  @override
  State<BookHotelBottomSheet> createState() => _BookHotelBottomSheetState();
}

class _BookHotelBottomSheetState extends State<BookHotelBottomSheet> {
  DateTime? _startDate;
  DateTime? _endDate;
  ...
  void _confirmBooking() async {
    if (_startDate == null || _endDate == null) {
      DialogeUtils.showMassage(
        context: context,
        masseage: 'Please select check-in and check-out dates',
    ...
    try {
      ...
      await context.read<BookingProvider>().bookItem('hotel', widget.hotelId, data: data);
      ...
      if (mounted) {
        DialogeUtils.showMassage(
          context: context,
          masseage: 'Your booking for ${widget.hotelName} was successful.',
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'e.g. Non-smoking room, high floor, twin beds, etc.',
                hintStyle: TextStyle(
